<template>
	<view class="page-wrapper">
		<search-bar class="search-bar block" @click='goSearchPage' />
		<view class="cell block">
			<view>历史搜索</view>
			<view class="cell-list block">
				<view class="cell-list__item" v-for="item in historyList" :key="item">{{item}}</view>
			</view>
		</view>
		<view class="cell block">
			<view>推荐搜索</view>
			<view class="cell-list block">
				<view class="cell-list__item" v-for="item in recommendList" :key="item">{{item}}</view>
			</view>
		</view>
		<view class="cell block">
			<view>热搜榜</view>
